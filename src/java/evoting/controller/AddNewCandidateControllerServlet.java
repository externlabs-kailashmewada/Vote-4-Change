    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
           ...
           for(FileItem fit: multiList)
           {
                ...
                else
                {
                 ...
                 String CandidateId=CandidateDAO.checkPartyByCity(objValues.get(4),objValues.get(3));
                // System.out.println("CD ID  "+CandidateId);
                if(CandidateId!=null)
                {
                   request.setAttribute("present",CandidateId);
                ...
                else
                {
                   ...
                   //  System.out.println(candidate);
                     boolean result=CandidateDAO.addCandidate(candidate,l);
                   //  System.out.println("Result at AddNew Can "+ result);
                      if(result)
